...
## Table of content
1. [Veryfi Xamarin Lens iOS & Android Examples](#examples)
2. [Configuration](#configuration)
3. [Other platforms](#other_platforms)
4. [Get in contact with our team](#contact)

## Veryfi Lens Example <a name="example"></a>
![receipt](https://user-images.githubusercontent.com/46335146/163218032-fa4b3d1e-ac47-458b-a7f3-5682b4892e28.gif)
...
- Replace credentials in `MainActivity.cs` or `ViewController.cs` with yours
```
